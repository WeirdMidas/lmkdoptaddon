...
- Use PSI as the main killing method for LMKD. Abandon solutions like Minfree and focus on dynamic solutions that can respect the multitasking needs of modern devices with fewer false positives.
